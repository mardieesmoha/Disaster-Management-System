...
if ($result) {
echo '<script>alert("Your Case submitted successfully. Case Order number is "+"'.$orderno.'")</script>';
...
<head>
    ...
    <title>Disaster Management System | New Case</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Disaster Details</h1>
<form name="newtesting" method="post">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">New Disaster Alarm</h6>
                                </div>
                                <div class="card-body">
                        <div class="form-group">
                            <label>Full Name of Reporter</label>
 ...
 <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="state" name="state" placeholder="Enter the Disaster type" required="true">
                                        </div>
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Local Goverment</h6>
                                </div>
                                <div class="card-body">
                             <div class="form-group">
                                              <label>LGA</label>
