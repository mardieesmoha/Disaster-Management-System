...
<head>
    ...
    <title>Disaster Management System | Admin Profile</title>
...
?>
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Disastaer occurence Date: <?php  echo $row['AdminRegdate'];?></h6>
                                </div>
                                <div class="card-body">
...
<input type="text" class="form-control" name="mobilenumber" value=""<?php  echo $row['MobileNumber'];?>" required='true' maxlength='11'>
</div>
