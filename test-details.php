...
echo '<script>alert("Assigned to experts successfully.")</script>';
...
<head>
    ...
    <title>Disaster Management System | Case Details</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Incidence Details# <?php echo intval($_GET['oid']);?></h1>
<div class="row">
<?php 
$testid=intval($_GET['tid']);
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Incidence Details</h6>
                                </div>
                                <div class="card-body">
   
 <table class="table table-bordered"  width="100%" cellspacing="0">
    <tr>
    <th>Full Name of the Reporter</th> 
...
<!-- Test Information --->
                         <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Disaster Report</h6>
                                </div>
                                <div class="card-body">
...
<div class="row">
                         <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary" align="center">Case  Record History</h6>
                                </div>
                                <div class="card-body">
<?php if($num>0){
?>
...
<h4 align="center" style="color:red"> No Cases history found </h4>
         <?php } ?>           
...
endwhile;
  ?>
            ...
            <option value="On the Way for Collection">Report On the Way for Collection</option>
            <option value="Sample Collected">Report Collected</option>
            <option value="Sent to Lab">Under Investigation</option>
       ...
       <p id='reportfile'> Report <span style="color:red; font-size:12px;">(Upload a PDF File)</span>    <input type="file" name="report" id="report"></p>
       <p>
