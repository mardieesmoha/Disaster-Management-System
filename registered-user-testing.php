        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Disaster Records | Already Registeres Users</h1>
...
<form name="newtesting" method="post">
 ...
 <div class="form-group">
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">LocolGoverment</h6>
                                </div>
                                <div class="card-body">
                             <div class="form-group">
                                              <label>LGA</label>
                                            ...
                                            <option value="Funtua">Funtua</option>   
                                                      ...
                                                      <div class="form-group">
                                            <label>Time Slot for Incident</label>
